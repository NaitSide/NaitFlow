...
NaitFlow делает работу со страницами Obsidian спокойнее и нагляднее: добавляет эмодзи и иконки Lucide, широкие обложки, вложенные страницы и отдельное дерево страниц. Метаданные сохраняются во frontmatter Markdown, а загруженные изображения — внутри хранилища Obsidian.
